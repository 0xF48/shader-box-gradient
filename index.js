(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ShaderBoxGradient"] = factory();
	else
		root["ShaderBoxGradient"] = factory();
...
module.exports = function(canvas, opt = {}) {
  var box, pause, run, shader, stop_anim, tick;
  if (opt.speed === null) {
    opt.speed = 0;
  }
  if (opt.fade === null) {
  ...
  tick = function(t) {
    ...
    return box.clear().draw(shader);
  };
  pause = function() {
    return stop_anim = true;
  };
  run = function() {
    stop_anim = false;
    return tick(0);
  ...
  return {box, shader, tick, pause, run};
};
